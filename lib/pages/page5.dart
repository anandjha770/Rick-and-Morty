...
class _Page5State extends State<Page5> {
  ...
  Future<void> getData() async {
    final String url = "https://rickandmortyapi.com/api/character/?page=5";
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(title: Text("Page 5",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w500),),trailing: Icon(Icons.double_arrow_rounded,size: 40,color: Colors.black.withOpacity(0.6),),onTap: (){Navigator.pop(context);},),
                    ],
                  ),
                )
              ],
