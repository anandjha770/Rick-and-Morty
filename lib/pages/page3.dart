...
class _Page3State extends State<Page3> {
  ...
  Future<void> getData() async {
    final String url = "https://rickandmortyapi.com/api/character/?page=3";
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ListTile(title: Text("Page 1",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w500),),trailing: Icon(Icons.double_arrow_rounded,size: 40,color: Colors.black.withOpacity(0.6),),onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context) => MyHomePage()));},),
                      ...
                      ListTile(title: Text("Page 3",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w500),),trailing: Icon(Icons.double_arrow_rounded,size: 40,color: Colors.black.withOpacity(0.6),),onTap: (){Navigator.pop(context);},),
