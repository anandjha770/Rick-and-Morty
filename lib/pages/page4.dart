...
class _Page4State extends State<Page4> {
  ...
  Future<void> getData() async {
    final String url = "https://rickandmortyapi.com/api/character/?page=4";
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(title: Text("Page 4",style: TextStyle(fontSize: 25,fontWeight: FontWeight.w500),),trailing: Icon(Icons.double_arrow_rounded,size: 40,color: Colors.black.withOpacity(0.6),),onTap: (){Navigator.pop(context);},),
